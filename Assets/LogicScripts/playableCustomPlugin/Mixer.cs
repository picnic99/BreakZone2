...
public class Mixer : AnimBehaviour
{
    ...
    public bool isTranslation => m_isTransition;
    ...
    public override void Disable()
    {
        ...
        for (int i = 0; i < inputCount; i++)
        {
            ...
            m_animMixer.SetInputWeight(i, 0);
        }
    }
    ...
    public void TransitionTo(int target)
    {
        ...
        if(m_declineIndex.Count -1 >= m_targetIndex)
        {
            m_declineIndex.RemoveAt(m_targetIndex);
        }
